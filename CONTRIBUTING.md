...
* If you find solution to an [issue/improvements](https://github.com/Ibracilinks/ZIpArchive/issues) in package that would be helpful to everyone, feel free to send us a pull request.
